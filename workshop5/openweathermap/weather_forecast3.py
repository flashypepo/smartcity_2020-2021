...
2020-1103 PP versie 3 OLED-versie using class OpenWeatherMap
versie 3: 4 lines on OLED
"""
...
# display a message of 4 lines, first line big font
def display_message(top_line, line_2, line_3, line_4):
    ...
    # line 2
    draw.text((x0,30), line_2, font=smallfont, fill=255)
    # line 3
    draw.text((x0,40), line_3, font=smallfont, fill=255)
    # line 4
    draw.text((x0,50), line_4, font=smallfont, fill=255)
    # display result
    disp.image(image)
    disp.show()
...
if __name__ == "__main__":
    ...
    line4 = "Desc: {}".format(descr)
    print(f"{topline}\n{line2}\n{line3}\n{line4}")
    display_message(topline, line2, line3, line4)
